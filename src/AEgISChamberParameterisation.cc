...
//
//
/// \file AEgISChamberParameterisation.cc
/// \brief Implementation of the AEgISChamberParameterisation class
...
AEgISChamberParameterisation::AEgISChamberParameterisation(  
        G4int    noChambers, 
 ...
 : G4VPVParameterisation()
{
   ...
   if( noChambers > 0 ){
      ...
      if (spacingZ < widthChamber) {
         G4Exception("AEgISChamberParameterisation::AEgISChamberParameterisation()",
...
void AEgISChamberParameterisation::ComputeTransformation
...
void AEgISChamberParameterisation::ComputeDimensions
